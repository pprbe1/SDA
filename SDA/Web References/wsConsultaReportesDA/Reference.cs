...
namespace SDA.wsConsultaReportesDA {
    ...
    public partial class wsConsultaReportesDA : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        public Error InsertBeneficiarioDA(string Nombre_1, string Nombre_2, string Apellido_Pat, string Apellido_Mat, string Porcentaje, int IdParentesco, int IdSaldosDA) {
        ...
        /// <remarks/>
        public void InsertBeneficiarioDAAsync(string Nombre_1, string Nombre_2, string Apellido_Pat, string Apellido_Mat, string Porcentaje, int IdParentesco, int IdSaldosDA) {
            this.InsertBeneficiarioDAAsync(Nombre_1, Nombre_2, Apellido_Pat, Apellido_Mat, Porcentaje, IdParentesco, IdSaldosDA, null);
        }
        
        /// <remarks/>
        public void InsertBeneficiarioDAAsync(string Nombre_1, string Nombre_2, string Apellido_Pat, string Apellido_Mat, string Porcentaje, int IdParentesco, int IdSaldosDA, object userState) {
