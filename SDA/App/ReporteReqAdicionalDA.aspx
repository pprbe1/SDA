<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ReporteReqAdicionalDA.aspx.cs" Inherits="SDA.App.ReporteReqAdicionalDA" %>
...
<body>
    ...
    <ext:ResourceManager ID="ResourceManager1" runat="server" Theme="Gray">
        ...
        <ext:FormPanel ID="FormPanel1" runat="server" Title="Reporte Requerimiento Adicional SDA - Información General" Icon="Information" AutoHeight="true" Layout="ColumnLayout" Collapsible="true">
                <Items>
                    ...
                    <Items>
                                    ...
                                    <ext:Model ID="Model3" runat="server" IDProperty="Id">
                                        ...
                                        <Fields>
                                            <ext:ModelField Name="IdReclamo" />
                                                    ...
                                                    <ext:ModelField Name="TipoRequerimiento" />
                                                    <ext:ModelField Name="FechaRequerimiento" />
                                        </Fields>
                                    </ext:Model>
                                </Model>
                            </ext:Store>
                        ...
                        <ColumnModel ID="ColumnModel1" runat="server">
                            <Columns>
                                ...
                                <ext:Column ID="Column13" runat="server" Text="Tipo Requerimiento" DataIndex="TipoRequerimiento" Flex="1" />
                                <ext:Column ID="Column14" runat="server" Text="Fecha Requerimiento" DataIndex="FechaRequerimiento" Flex="1" />
                            </Columns>
                        </ColumnModel>
                        <SelectionModel>
