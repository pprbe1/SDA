<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ReporteSinEstatusDA.aspx.cs" Inherits="SDA.App.ReporteSinEstatusDA" %>
...
<body>
    ...
    <ext:ResourceManager ID="ResourceManager1" runat="server" Theme="Gray">
        ...
        <ext:FormPanel ID="FormPanel1" runat="server" Title="Reporte Esatus Siniestro - Información General" Icon="Information" AutoHeight="true" Layout="ColumnLayout" Collapsible="true">
                <Items>
                    ...
                    <Items>
                                    ...
                                    <ext:Model ID="Model3" runat="server" IDProperty="Id">
                                        ...
                                        <Fields>
                                            <ext:ModelField Name="IdReclamo" />
                                                    ...
                                                    <ext:ModelField Name="SaldoTotal" />
                                        </Fields>
                                    </ext:Model>
                                </Model>
                            </ext:Store>
                        ...
                        <ColumnModel ID="ColumnModel1" runat="server">
                            <Columns>
                                ...
                                <ext:Column ID="Column13" runat="server" Text="Estatus" DataIndex="Estatus" Width="90" />
                                <ext:Column ID="Column14" Align="Right" runat="server" Text="Monto" DataIndex="SaldoTotal" >
