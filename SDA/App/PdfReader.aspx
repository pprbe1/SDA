<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PdfREader.aspx.cs" Inherits="SDA.App.PdfReader" %>
...
<html>
  <head>
    ...
    <script type="text/javascript" src="/Scripts/pdf/compatibility.js"></script>
    <script type="text/javascript" src="/Scripts/pdf/l10n.js"></script>
    <script type="text/javascript" src="/Scripts/pdf/pdf.js"></script>
    <script type="text/javascript" src="/Scripts/pdf/viewer.js"></script>
  </head>
  <body tabindex="1">
