<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ReporteFiniquitos.aspx.cs" Inherits="SDA.App.ReporteFiniquitos" %>
                    ...
                    <Items>
                        ...
                        <ColumnModel ID="ColumnModel1" runat="server">
                            <Columns>
                                ...
                                <ext:Column ID="Column13" runat="server" Text="Beneficiario" DataIndex="NombreBeneficiario" Width="250"/>
                                <ext:Column ID="Column14" Align="Right" runat="server" Text="Monto" DataIndex="SaldoBene" Flex="1" >
