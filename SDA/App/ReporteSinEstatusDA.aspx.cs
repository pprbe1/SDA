...
namespace SDA.App
{
    public partial class ReporteSinEstatusDA : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            List<wsConsultaReportesDA.ReporteSiniestrosDA> lista = new List<wsConsultaReportesDA.ReporteSiniestrosDA>(reportegral.ReporteSiniestros(1, fechaInicio, fechaFin, 8));
